  ...
  ({ className, children, ...props }, ref) => {
    return (
      <Button
        ...
        {...props}
      >
        {children || <FaLink className="tiptap-button-icon" />}
      </Button>
    )
  }
)
    ...
    <>
      ...
      <div className="tiptap-button-group" data-orientation="horizontal">
        <Button
          ...
          data-style="ghost"
        >
          <FaLevelDownAlt className="tiptap-button-icon" />
        </Button>
      </div>
      ...
      <div className="tiptap-button-group" data-orientation="horizontal">
        <Button
          ...
          data-style="ghost"
        >
          <FaExternalLinkAlt className="tiptap-button-icon" />
        </Button>
        ...
        <Button
          ...
          data-style="ghost"
        >
          <FaTrash className="tiptap-button-icon" />
        </Button>
      </div>
    </>
  )
