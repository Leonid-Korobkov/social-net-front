...
import { Like, CommentLike } from '@/store/types'
import {
  useCreateLikeMutation,
  useDeleteLikeMutation,
} from '@/store/services/like.api'
import { useToggleCommentLikeMutation } from '@/store/services/likeComment.api'
import { useDeletePostMutation } from '@/store/services/post.api'
